package com.itsfercodes.code_school.aspects;
...
public class LoggerAspect {
  ...
  @Around("execution(* com.itsfercodes.code_school..*.*(..))")
  ...
  @AfterThrowing(value = "execution(* com.itsfercodes.code_school.*.*(..))", throwing = "ex")
